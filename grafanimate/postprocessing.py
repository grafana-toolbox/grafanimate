...
def upload_server(source):
    command = "make --makefile=/Users/amo/dev/hiveeyes/sources/documentation/Makefile ptrace source={}".format(source)
    os.system(command)
